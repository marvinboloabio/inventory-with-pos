...
<div class="container mt-5">
    <h2 class="mb-4">UOM Management</h2>
    <div class="d-flex justify-content-between mb-4">
        <input type="text" id="searchSupplier" class="form-control search-bar" placeholder="Search measurement">
        <button class="btn btn-primary" data-toggle="modal" data-target="#supplierModal" onclick="clearSupplierForm()">Add measurement</button>
    </div>
...
<script src="../assets/js/uom.js"></script>
</body>
</html>
