...
$(document).ready(function () {
    ...
    $('#searchSupplier').on('keyup', function () {
        ...
        const filteredSuppliers = suppliers.filter(supplier =>
            supplier.brand_name.toLowerCase().includes(searchValue) ||
    ...
    suppliers.forEach((supplier) => {
        const row = `
             <tr>
                 ...
                 <td>
                     <button class="btn btn-primary btn-sm" onclick="editSupplier(${supplier.brand_id})">Edit</button>
                 </td>
             </tr>
         `;
...
function editSupplier(id) {
    const supplier = suppliers.find(supplier => supplier.brand_id == id);
    $('#supplierId').val(supplier.brand_id);
    $('#supplierName').val(supplier.brand_name);
